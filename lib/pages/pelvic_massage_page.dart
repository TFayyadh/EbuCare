...
class PelvicMassagePage extends StatefulWidget {
  const PelvicMassagePage({super.key});

  @override
  State<PelvicMassagePage> createState() => _PelvicMassagePageState();
}

class _PelvicMassagePageState extends State<PelvicMassagePage> {
            ...
            children: [
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Text(
                            "Pelvic and Core Muscle Recovery",
                            style: TextStyle(
                              fontFamily: "Calsans",
                              fontSize: 20,
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  final bookingData = {
                    'user_id': user.id,
                    'package_type': 'Pelvic and Core Muscle Recovery',
                    'start_date': startStr,
                    'end_date': endStr,
                    'address': addressController.text,
                    'phone': phoneController.text,
                    'status': 'Pending',
                    'price': 279, // example price
