...
class RelaxationMassagePage extends StatefulWidget {
  const RelaxationMassagePage({super.key});

  @override
  State<RelaxationMassagePage> createState() => _RelaxationMassagePageState();
}

class _RelaxationMassagePageState extends State<RelaxationMassagePage> {
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  final bookingData = {
                    'user_id': user.id,
                    'package_type': 'Relaxation Massage',
